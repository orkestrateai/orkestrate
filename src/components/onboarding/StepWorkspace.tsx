...
import { Check, CheckCircle2, ChevronDown, ExternalLink, Loader2 } from "lucide-react";
    ...
    <div className="space-y-8">
      {!isConnected ? (
        <div className="rounded-xl border border-white/5 bg-white/[0.02] p-4 text-center">
          <div className="mb-2 text-[13px] font-semibold text-zinc-400">GitHub Connection Lost</div>
          <div className="text-[12px] text-zinc-600">
            Please return to the previous step to reconnect your account.
          </div>
        </div>
      ) : (
        <>
          <div className="space-y-2">
            ...
            {isBrowsingRepos ? (
              <div className="max-h-56 overflow-y-auto rounded-xl border border-white/5 bg-white/[0.01]">
                {repos.length === 0 ? (
                    ...
                    <>
                      ...
                      >
                        {branches.length > 0 ? (
                          ...
                          <div className="px-3 py-2 text-sm text-zinc-500">No branches found.</div>
                        )}
                      </motion.div>
                    </>
                  )}
