...
export function proxy(request: NextRequest) {
    ...
    const cspHeaderVersion = `
        ...
        connect-src 'self' wss: https: vitals.vercel-insights.com *.vercel.live *.vercel.com https://api.razorpay.com;
        frame-src 'self' https://vercel.live https://*.vercel.live https://vercel.com https://*.vercel.com https://api.razorpay.com https://checkout.razorpay.com;
