        ...
        <div className="bg-white/[0.03] backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-2xl space-y-6">
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full h-12 flex items-center justify-center gap-3 bg-[#24292F] text-white hover:bg-[#24292F]/90 disabled:opacity-50 transition-all rounded-xl text-sm font-medium border border-white/10"
            >
              {githubLoading ? (
                <Loader2 className="w-4 h-4 animate-spin" />
              ) : (
