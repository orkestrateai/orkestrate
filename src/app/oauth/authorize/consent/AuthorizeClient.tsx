    ...
    <main className="min-h-screen bg-[#050505] text-[#F2F2F2] font-sans selection:bg-white/10 overflow-hidden relative flex flex-col items-center justify-center">
      ...
      <AnimatePresence>
        {showUI && (
          ...
          >
            <div className="bg-white/3 backdrop-blur-2xl border border-white/10 rounded-3xl p-8 shadow-[0_24px_80px_rgba(0,0,0,0.5)]">
              ...
              <div className="flex flex-col items-center gap-6 mb-10">
                <div className="h-px w-12 bg-linear-to-r from-transparent via-white/10 to-transparent" />
                <p className="text-[14px] text-white/50 text-center leading-relaxed max-w-[320px]">
                  To begin, simply tell your agent to{" "}
                  <span className="text-emerald-400/90 font-medium">
                    join workspace
                  </span>{" "}
                  and experience the future of coordination.
                </p>
                <div className="h-px w-12 bg-linear-to-r from-transparent via-white/10 to-transparent" />
              </div>
              ...
              {!user ? (
                <div className="space-y-4">
                  <p className="text-[13px] text-white/40 text-center px-4 leading-relaxed">
                    Please sign in to your Orkestrate account to proceed with
                    this authorization.
                  </p>
                  <button
                    onClick={handleLogin}
                ...
                <form method="GET" action="/api/oauth/authorize">
                  ...
                  <div className="mb-6 px-5 py-4 bg-white/4 border border-white/10 rounded-2xl flex items-center justify-between">
